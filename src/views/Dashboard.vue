  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow py-2 px-1 lg:p-4 flex gap-2 items-center justify-between">
      ...
      <div class="flex flex-col lg:flex-row items-center gap-1 lg:gap-3">
        <router-link to="/add-log" class="bg-gradient-to-r from-blue-400 to-blue-600 rounded px-4 py-2 text-sm md:text-base rounded text-white">+ Add <span class="hidden lg:inline">New</span> Log <span class="hidden lg:inline">Entry</span></router-link>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-4">
  <!-- Total Entries -->
  <div class="bg-gradient-to-r from-blue-400 to-blue-600 rounded shadow p-4 text-white flex items-center gap-4 rounded-lg">
  ...
  <!-- Approved -->
  <div class="bg-gradient-to-r from-green-400 to-green-600 rounded shadow p-4 text-white flex items-center gap-4 rounded-lg">
    <svg class="w-10 h-10" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
  ...
  <!-- Pending -->
  <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded shadow p-4 text-white flex items-center gap-4 rounded-lg">
    <svg class="w-10 h-10" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      <path stroke-linecap="round" stroke-linejoin="round" 
  ...
  <!-- Rejected -->
  <div class="bg-gradient-to-r from-red-400 to-red-600 rounded shadow p-4 text-white flex items-center gap-4 rounded-lg">
    <svg class="w-10 h-10" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      <path stroke-linecap="round" stroke-linejoin="round"
